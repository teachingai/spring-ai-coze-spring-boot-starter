...
public class CozeAiChatOptions implements FunctionCallingOptions, ChatOptions {
    ...
    private @JsonProperty("tools") List<CozeAiApi.FunctionTool> tools;

    /**
     * 用于控制模型是如何选择要调用的函数，仅当工具类型为function时补充。默认为auto，当前仅支持auto
     */
    @NestedConfigurationProperty
    private @JsonProperty("tool_choice") CozeAiApi.ChatCompletionRequest.ToolChoice toolChoice;
    ...
    public static class Builder {
        ...
        private final CozeAiChatOptions options = new CozeAiChatOptions();
        ...
        public Builder withTools(List<CozeAiApi.FunctionTool> tools) {
            this.options.setTools(tools);
            return this;
        }

        public Builder withToolChoice(CozeAiApi.ChatCompletionRequest.ToolChoice toolChoice) {
            this.options.setToolChoice(toolChoice);
            return this;
        }

        public CozeAiChatOptions build() {
            return this.options;
        }
    ...
    public List<CozeAiApi.FunctionTool> getTools() {
        return tools;
    }

    public void setTools(List<CozeAiApi.FunctionTool> tools) {
        this.tools = tools;
    }

    public CozeAiApi.ChatCompletionRequest.ToolChoice getToolChoice() {
        return toolChoice;
    }

    public void setToolChoice(CozeAiApi.ChatCompletionRequest.ToolChoice toolChoice) {
        this.toolChoice = toolChoice;
    }

    /**
     * Convert the {@link CozeAiChatOptions} object to a {@link Map} of key/value pairs.
    ...
    /**
     * Helper factory method to create a new {@link CozeAiChatOptions} instance.
     * @return A new {@link CozeAiChatOptions} instance.
     */
    public static CozeAiChatOptions create() {
        return new CozeAiChatOptions();
    }
